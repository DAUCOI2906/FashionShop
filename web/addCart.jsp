...
<html lang="en">
    ...
    <body>
        ...
        <section class="container content-section" id="content-section">
                            ...
                            <div class="cart-quantity cart-column">
                                ...
                                <script>
                                    ...
                                    myNumber.addEventListener('input', (event) => {
                                        ...
                                        document.querySelector("a[href*='cartsp']").href = "cartsp?cid=<%=request.getParameter("cid")%>&iduser=<%=request.getParameter("iduser")%>&soluong=" + myNumber.value;;
            ...
            <a href="cartsp?cid=<%=request.getParameter("cid")%>&iduser=<%=request.getParameter("iduser")%>&soluong=1">
                <input class="btn btn-primary btn-purchase" id="Submit1" type="submit" value="ADD TO CART" />
